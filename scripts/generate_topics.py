...
Return ONLY the topic string. No quotes, no preamble."""
    ...
    return generate(system=system, user="Generate one video topic for tonight.",
                        max_tokens=200, temperature=0.85).strip().strip('"').strip("'")
                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                public_id=f"dopamine-studios/queue/tonight-topics-{date_str}",
                                                                                                                                                                                                                                                                                                                                        resource_type="raw", overwrite=True,
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                print(f"[OK] Topics saved: {result['secure_url']}")
                                                                                                                                                                                                                                                                                                                                                    print(f"[DONE] Channels: {list(tonight_topics.keys())}")
