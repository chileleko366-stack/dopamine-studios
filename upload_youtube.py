...
# Per-channel YouTube credentials stored as secrets
# Secret names: YOUTUBE_CLIENT_ID_CH1, YOUTUBE_REFRESH_TOKEN_CH1, etc.
CLIENT_ID     = os.environ.get(f"YOUTUBE_CLIENT_ID_{CHANNEL_ID}") or os.environ.get("YOUTUBE_CLIENT_ID")
CLIENT_SECRET = os.environ.get(f"YOUTUBE_CLIENT_SECRET_{CHANNEL_ID}") or os.environ.get("YOUTUBE_CLIENT_SECRET")
REFRESH_TOKEN = os.environ.get(f"YOUTUBE_REFRESH_TOKEN_{CHANNEL_ID}") or os.environ.get("YOUTUBE_REFRESH_TOKEN")
...
def main():
    ...
    if not CLIENT_ID or not REFRESH_TOKEN:
        log("[ERROR] Missing YouTube credentials. Check GitHub secrets.")
        sys.exit(1)
